    ...
    <UApp>
        <div class="min-h-screen bg-white py-8">
            <div class="max-w-4xl mx-auto px-4">
                ...
                <!-- Основной контент -->
                <div v-else-if="userData?.operationResult === 'OK'" class="space-y-6">
                    <!-- Шапка профиля -->
                    <UCard class="overflow-hidden border border-gray-200 shadow-sm hover:shadow-md transition-all duration-300">
                        <div class="flex items-start justify-between">
                            <div class="flex items-center gap-4">
                                <div class="h-16 w-16 bg-zinc-900 rounded-full flex items-center justify-center shadow-md">
                                    <UIcon name="i-lucide-user" class="h-8 w-8 text-white" />
                                </div>
                                <div class="v-col">
                    ...
                    <UCard class="border border-gray-200 shadow-sm hover:shadow-md transition-all duration-300">
                        <template #header>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <UCard class="border border-gray-200 shadow-sm hover:shadow-md hover:border-blue-200 transition-all duration-300">
                            <template #header>
                        ...
                        <UCard class="border border-gray-200 shadow-sm hover:shadow-md hover:border-green-200 transition-all duration-300">
                            <template #header>
                                <h3 class="font-semibold text-gray-900 flex items-center gap-2">
                    ...
                    <UCard v-if="statisticsMonths.length > 0" class="border border-gray-200 shadow-sm hover:shadow-md transition-all duration-300">
                        <template #header>
                    ...
                    <UCard v-if="userData.object.employee" class="border border-gray-200 shadow-sm hover:shadow-md transition-all duration-300">
                        <template #header>
                            <h2 class="text-lg font-semibold text-gray-900 flex items-center gap-2">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                            ...
                            <div class="flex items-center gap-3 p-4 border border-gray-100 rounded-lg hover:border-gray-200 hover:bg-gray-50 transition-all duration-300 group">
                                ...
                                <div>
                                    ...
                                    <p class="font-medium text-gray-900">{{ userData.object.employee.note || '—' }}</p>
                                </div>
                            </div>
                        </div>
                    </UCard>
