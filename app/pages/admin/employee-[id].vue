    ...
    <div class="min-h-screen mb-10 dark:bg-gray-900 dark:text-gray-100">
      <div class="max-w-4xl mx-auto px-4">
        ...
        <div v-else-if="userData?.operationResult === 'OK'" class="space-y-6" ref="contentGroup">
                ...
                <div class="v-col">
                  ...
                  <div class="flex flex-col">
                    ...
                    <UInput
                      ...
                      variant="none"
                      class="text-2xl font-bold p-0 dark:bg-gray-800 dark:text-white"
                      placeholder="ФИО"
                      aria-label="ФИО"
                    />
                    <div class="flex items-center gap-3 mt-2">
                      ...
                      <span v-if="userData.object.login && !editMode" class="text-sm text-gray-500 dark:text-gray-400 flex items-center gap-1">
          ...
          <UCard class="border border-gray-200 dark:border-gray-700 shadow-sm hover:shadow-md transition-all duration-300 dark:bg-gray-800">
            <template #header>
                ...
                <div class="flex-1">
                  ...
                  <div class="flex items-center gap-1 mt-1">
                    <UInput
                      ...
                      variant="none"
                      type="text"
                      class="w-full p-0 dark:bg-gray-800 dark:text-white"
                      placeholder="+7..."
                      aria-label="Телефон"
                    />
                    <UButton
                      v-if="(form.phone || userData.object.phone) && !editMode"
                      color="info"
                      variant="ghost"
                      icon="i-lucide-copy"
                      size="xs"
              ...
              <div class="flex items-center gap-3 p-4 border border-gray-100 dark:border-gray-600 rounded-lg hover:border-green-200 dark:hover:border-green-800 hover:bg-green-50 dark:hover:bg-green-900/20 transition-all duration-300 group">
                ...
                <div class="flex-1">
                  ...
                  <UInput
                    ...
                    variant="none"
                    type="email"
                    class="w-full p-0 mt-1 dark:bg-gray-800 dark:text-white"
              ...
              <div class="flex items-center gap-3 p-4 border border-gray-100 dark:border-gray-600 rounded-lg hover:border-emerald-200 dark:hover:border-emerald-800 hover:bg-emerald-50 dark:hover:bg-emerald-900/20 transition-all duration-300 group">
                ...
                <div>
                  ...
                  <p class="font-medium text-gray-900 dark:text-white mt-1">
                    {{ userData.object.confirmed ? 'Подтвержден' : 'Не подтвержден' }}
                  </p>
                </div>
              </div>

              <!-- Примечание -->
              <div class="flex items-center gap-3 p-4 border border-gray-100 dark:border-gray-600 rounded-lg hover:border-gray-200 dark:hover:border-gray-500 hover:bg-gray-50 dark:hover:bg-gray-700 transition-all duration-300 group md:col-span-2">
            ...
            <div class="v-col gap-3">
              ...
              <div class="flex flex-col gap-1 p-4 border border-gray-100 dark:border-gray-600 rounded-lg bg-zinc-50 dark:bg-gray-700">
                ...
                <div class="flex flex-wrap gap-2 items-center">
                  <UTooltip text="Надбавка за лидирование клиента">
                    <span v-if="!editMode" class="text-sm font-semibold text-blue-700 dark:text-blue-300 bg-blue-100 dark:bg-blue-900/30 px-2 py-1 rounded inline-flex items-center gap-1">
                      Лид
                  ...
                  <UTooltip text="Надбавка за руководство отделом">
                    <span v-if="!editMode" class="text-sm font-semibold text-green-700 dark:text-green-300 bg-green-100 dark:bg-green-900/30 px-2 py-1 rounded inline-flex items-center gap-1">
                      Отдел
                      <UIcon name="i-lucide-info" class="w-3 h-3" />
                  ...
                  <UTooltip text="Надбавка за менеджерскую работу">
                    <span v-if="!editMode" class="text-sm font-semibold text-amber-700 dark:text-amber-300 bg-amber-100 dark:bg-amber-900/30 px-2 py-1 rounded inline-flex items-center gap-1">
                      Менеджер
                      <UIcon name="i-lucide-info" class="w-3 h-3" />
                  ...
                  <UTooltip text="Надбавка за продажи">
                    <span v-if="!editMode" class="text-sm font-semibold text-purple-700 dark:text-purple-300 bg-purple-100 dark:bg-purple-900/30 px-2 py-1 rounded inline-flex items-center gap-1">
                      Продажи
                      <UIcon name="i-lucide-info" class="w-3 h-3" />
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-3">
                <div>
                  ...
                  <div v-if="!editMode && userData.object.employee.department" class="font-medium text-gray-900 dark:text-white mt-1">
                  ...
                  <UInput
                    ...
                    type="text"
                    placeholder="Отдел"
                    class="mt-1 dark:bg-gray-800 dark:text-white"
                  />
                </div>

                <div>
                  <p class="text-xs text-gray-500 dark:text-gray-400 uppercase tracking-wide">Примечание (employee)</p>
                  <div v-if="!editMode && userData.object.employee.note" class="font-medium text-gray-900 dark:text-white mt-1">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <UCard class="border border-gray-200 dark:border-gray-700 shadow-sm hover:shadow-md hover:border-blue-200 dark:hover:border-blue-800 transition-all duration-300 dark:bg-gray-800">
              <template #header>
                <h3 class="font-semibold text-gray-900 dark:text-white flex items-center gap-2">
            ...
            <UCard class="border border-gray-200 dark:border-gray-700 shadow-sm hover:shadow-md hover:border-green-200 dark:hover:border-green-800 transition-all duration-300 dark:bg-gray-800">
              <template #header>
                <h3 class="font-semibold text-gray-900 dark:text-white flex items-center gap-2">
          ...
          <UCard v-if="statisticsMonths.length > 0" class="border border-gray-200 dark:border-gray-700 shadow-sm hover:shadow-md transition-all duration-300 dark:bg-gray-800">
            <template #header>
        ...
        <div v-else class="text-center py-16 border border-gray-200 dark:border-gray-700 rounded-lg bg-white dark:bg-gray-800">
          ...
          <p class="text-gray-600 dark:text-gray-400 mb-6">Не удалось загрузить информацию о сотруднике</p>
          <UButton
            variant="outline"
